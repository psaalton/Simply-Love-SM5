...
local af = Def.ActorFrame{
	InitCommand=function(self)
		...
		if ThemePrefs.Get("VisualStyle")=="Gay" or ThemePrefs.Get("VisualStyle")=="Pride" and not HolidayCheer() then
	...
	LoadFont("Common Bold")..{
		...
		GainFocusCommand=function(self) if ThemePrefs.Get("VisualStyle")=="Gay" or ThemePrefs.Get("VisualStyle")=="Pride"  then self:rainbowscroll(true) end end,
		LoseFocusCommand=function(self) if ThemePrefs.Get("VisualStyle")=="Gay" or ThemePrefs.Get("VisualStyle")=="Pride"  then self:rainbowscroll(false) end end,
	}
}
