if not ThemePrefs.Get("RainbowMode") and ThemePrefs.Get("VisualStyle") ~= "SRPG5" and ThemePrefs.Get("VisualStyle") ~= "Unicorn" and ThemePrefs.Get("VisualStyle") ~= "Pride" then return Def.Actor{ InitCommand=function(self) self:visible(false) end } end
